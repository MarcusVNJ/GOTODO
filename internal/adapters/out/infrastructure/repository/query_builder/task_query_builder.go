...
func (query_builder *TaskQueryBuilder) QueryInsert(entity entity.TaskEntity) (string, []any, error) {
...
func (query_builder *TaskQueryBuilder) QueryExistsById(id string) (string, []any, error) {
	return query_builder.psql.
		Select("1").
		From("tasks").
		Where(sq.Eq{"id": id}).
		Limit(1).
...
func (query_builder *TaskQueryBuilder) QueryFindById(id string) (string, []any, error) {
...
func (query_builder *TaskQueryBuilder) QueryUpdate(entity entity.TaskEntity) (string, []any, error) {
...
func (query_builder *TaskQueryBuilder) QueryDelete(id string) (string, []any, error) {
	return query_builder.psql.Update("tasks").
...
func (query_builder *TaskQueryBuilder) QueryFindByStatus(status enums.Status) (string, []any, error) {
	return query_builder.psql.Select("*").
		From("tasks").
